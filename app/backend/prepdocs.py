...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        # help="Dimensions for the embedding model (defaults to 3072 for 'text-embedding-3-large')",
    )
    parser.add_argument(
        "--novectors",
        action="store_true",
    ...
    #     required=False,
    #     help="Optional. Use this Azure Document Intelligence account endpoint",
    # )
    parser.add_argument(
        "--searchimages",
        action="store_true",
    ...
    args = parser.parse_args(   [
        'C:/Users/464_0651/OneDrive - Yokogawa Electric Corporation/Azure_CWYD/azure-search-openai-demo/data/*',
        # 'C:/Users/464_0651/Desktop/icpdevfile/temp/*',
        '--verbose',
        # '-subscriptionid','1a0f82d9-ccd1-42b0-9cac-4de7dd762ece',
        '--storageaccount','icpdocumentstorage',
        '--container' ,'gsimdocumentreferring',
        '--storageresourcegroup', 'ODC-24-IDX-PQ102',
        '--searchservice', 'icpdocumentation',
        '--index','icpreferringindexes',
        '--openaihost' ,'azure',
        '--openaimodelname', 'text-embedding-ada-002',
        '--openaiservice' ,'ICPAIServices',
        '--openaideployment', 'icp-embedding-ada-002',
        # '--openaidimensions', '1536',
        '--documentintelligenceservice','icp-doc-intelligence',
        # '--documentintelligenceendpoint', 'https://icp-doc-intelligence.cognitiveservices.azure.com/',
        '--storagekey', 'XLgtRqyZTot7PltYdtkSmnpgg37HXs863NYUtz2Ff/JPFP7AKamcSb9YKa5fP1eYB20hsl6LHVwZ+ASt5CLX7w==',
        '--searchkey', 'ibGOL9dF3hdSmLBCtogv9H30GHjtECo78oex9JZEC5AzSeCdzb63',
        '--openaikey', 'EDXljsh0UmLLQBwuBWx6UjlZXSpaKfPip5oVzmwHynlhiEvlKZLUJQQJ99ALACi0881XJ3w3AAABACOGVNQD',
        '--documentintelligencekey', '8yD3ui1pZuUXDtm9BalptelKmAux3501xtFPngIhj5AcF035CyqlJQQJ99ALACi0881XJ3w3AAALACOGf9c6',
        '--useacls'      
       ] )
